...
Clone the repo: git clone https://github.com/ilaydayilidz778/BurgerOrderWebApplication
Navigate to the project directory: cd BurgerOrderWebApplication
Open the project in Visual Studio or run it from the terminal: dotnet run
Technologies Used
ASP .NET Core MVC
