...
namespace MvcOOPHamburgerProject.Areas.Admin.Controllers
{
    ...
    public class TestimonialsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description,Puan,ImageUrl")] Testimonial testimonial)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Description,Puan,ImageUrl")] Testimonial testimonial)
        {
