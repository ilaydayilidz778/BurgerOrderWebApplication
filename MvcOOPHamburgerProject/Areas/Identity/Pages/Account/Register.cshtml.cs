...
namespace MvcOOPHamburgerProject.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public SelectList RegionList { get; private set; }
            ...
            RoleManager<IdentityRole> roleManager)
        {
            ...
            CityList = new SelectList(cities, "Name", "Name");
        }
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var selectedCity = _context.Cities.FirstOrDefault(r => r.Name == Input.City);
